...
\textbf{Monitoring-Strategie (über die Pflichtanforderungen hinaus):} Die Praxis implementiert eine
...
\begin{itemize}
  ...
  \item Halbjährliche Stichproben-Auswertung in TOMs-Prüfung (angestrebt)
...
\begin{itemize}
  \item \textbf{macOS/iOS:} Systemeinstellungen → Softwareupdate (automatische Benachrichtigungen 
aktiviert, stichprobenartige Kontrolle monatlich oder bei Bedarf)
...
Eignung dieser Architektur für Enterprise-Umgebungen. Dritt-Anbieter-Software
...
Jährliche Überprüfung der Baseline-Konfiguration, halbjährlich angestrebt.
...
\begin{itemize}
  ...
  \item \PasswortManager{} Sicherheits-Dashboard Score: Ziel $\geq$\PasswortSecurityScore{} (halbjährliche Prüfung angestrebt, mindestens jährlich in TOMs-Prüfung, Abweichungen werden dokumentiert und bewertet)
\end{itemize}
...
\textbf{Backup-Überwachung:} Das Backup erfolgt automatisiert über Time Machine und \PVSName{}. 
Bei Fehlern erfolgt automatische Benachrichtigung. Die \PraxisInhaberBezeichnung{} führt 
stichprobenartige Kontrollen durch (wöchentlich angestrebt, mindestens monatlich). 
Bei Problemen wird der IT-Ansprechpartner unverzüglich informiert.

\textbf{Hinweis für Einzelpraxen:} Eine tägliche manuelle Prüfung ist bei automatisierter 
Überwachung und Benachrichtigung nicht erforderlich. Regelmäßige Stichproben gewährleisten 
die Funktionsfähigkeit ohne unverhältnismäßigen Aufwand.
