...
\textit{Basis: KBV-Richtlinie nach §390 SGB V, in Kraft seit 01.04.2025 (neue Anforderungen ab 01.10.2025)}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.7cm}
  ...
  &~\ref{sec:endgeraete} Endgeräte-Sicherheit \\
  27 & Konfiguration von Synchronisationsmechanismen (Windows) & n.a. &~\ref{sec:windows}
  Windows-Endgeräte \\
  28 & Datei- und Freigabeberechtigungen (Windows) & n.a. &~\ref{sec:windows} Windows-Endgeräte \\
  29 & Datensparsamkeit (Windows) & n.a. &~\ref{sec:windows} Windows-Endgeräte \\
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.7cm}
  ...
  4 & Sichere zentrale Authentisierung in Windows-Netzen (Kerberos/SSO): Ausschließlich Kerberos für SSO & n.a. & Nicht anwendbar (macOS-Umgebung, kein Windows-Netz) \\
...
9 der insgesamt 50 Anforderungen sind nicht anwendbar.
\begin{itemize}
...
\textbf{Anlage 2:} 8 von 9 anwendbaren Anforderungen vollständig erfüllt (\textbf{89\%
Compliance}), 1 teilweise erfüllt (\textbf{11\%}); 1 von 10 nicht anwendbar
\begin{itemize}
  \item 8 Anforderungen: + Vollständig erfüllt (Nr. 2,3,5,6,7,8,9,10)
  \item 1 Anforderung: ± Teilweise erfüllt (Nr. 1 - Logging vorhanden, kein zentrales SIEM)
  \item 1 Anforderung: n.a. Nicht anwendbar (Nr. 4 - macOS-Umgebung, kein Windows-Netz)
\end{itemize}
...
\textbf{Gesamtstatus:} Alle verpflichtenden Anforderungen gemäß KBV-Richtlinie nach
§390 SGB V erfüllt -- Anlage 1: 41/41 anwendbare (9 von 50 n.a.), Anlage 5: 9/9.
Zusätzlich wurden Anlage-2-Anforderungen (freiwillig) 8/9 vollständig und 1/9 teilweise
umgesetzt. (Rechtsgrundlage: A.IV.1; neue Pflichten ab 01.10.2025).
