...
% PDF und Hyperlinks
% Printable (PDF/X-1a): hyperref wurde bereits von pdfx geladen -> nur \hypersetup,
% sonst "Option clash for package hyperref". pdfa-Modus entfällt (pdfx setzt PDF/X-1a).
\ifprintable
  \hypersetup{
    bookmarks=true,
    bookmarksopen=true,
